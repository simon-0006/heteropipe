...
> This is the README inherited from NVIDIA [Megatron-LM](https://github.com/NVIDIA/Megatron-LM), the base of both CrossPipe and HeteroPipe. It is preserved here unmodified for attribution and reference. See the top-level [README.md](../README.md) for HeteroPipe.
